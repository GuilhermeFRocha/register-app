    ...
    products: [
      {
        ...
        descricao:
          "uma experiência única! Onde as fotos são reveladas instantaneamente à frente dos seus olhos (até 2 min. após o clique).",
        marca: "Fujicam",
        unidade_tipo: "qtd",
        unidade_valor: "233",
        image:
  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        descricao:
          "Impermeável: À prova d'água (33 m). Quer lavar as mãos ou nadar? Sem problemas! Para todos os tipos de situação, de reuniões de negócios a atividades internas, ou mesmo uso diário. Observação: Não aperte os botões na água.",
        marca: "Tummy",
        unidade_tipo: "kg",
        unidade_valor: "0.5",
        image:
...
export const mockProductList = [
  ...
  },
  {
    ...
    description:
      "Produzido em aço inoxidável de qualidade, que conserva as bebidas quentes por até 12h e frias por até 24h, a linha completa possui filtro em aço inox e outras.",
    brand: "Squez",
    quantity: "qtd",
    unit: "33",
    id: "2",
